  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0A1612]">
      ...
      <section id="home" className="relative min-h-[100svh] flex flex-col justify-center overflow-hidden pt-32 pb-6">
        ...
        <div className="absolute inset-0 bg-[url('/hero_spices_new.jpg')] bg-cover bg-center max-h-[100svh] hidden md:block"></div>
        {/* Dark gradient on the left for desktop text readability */}
        <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/40 to-transparent max-h-[100svh] hidden md:block"></div>

        {/* Mobile Background Image */}
        <div className="absolute inset-0 bg-[url('/hero_mobile.jpg')] bg-cover bg-center md:hidden"></div>
        ...
        <div className="w-full px-6 sm:px-12 lg:px-16 relative z-10 flex-1 flex flex-col justify-center mt-12 md:mt-20">
          ...
          <ScrollReveal className="text-center md:text-left w-full max-w-3xl relative px-2 mx-auto md:mx-0">
            ...
            <p className="text-center md:text-left text-sm md:text-base lg:text-lg text-white/90 font-medium max-w-xl mb-10 leading-relaxed drop-shadow-md mx-auto md:mx-0">
