...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section id="home" className="relative flex min-h-screen items-center justify-center overflow-hidden bg-green-50">
        ...
        <div className="relative z-10 text-center p-10 md:p-16 bg-white/40 backdrop-blur-xl rounded-3xl border border-white/60 shadow-2xl max-w-xl mx-4">
          ...
          <p className="mt-8 text-2xl md:text-3xl font-semibold text-gray-800 text-justify">
            Website Launching Soon
          </p>

          <p className="mt-3 text-lg text-gray-600 font-medium text-justify">
      ...
      {/* Products Section */}
      <section id="products" className="bg-green-50/50">
        <Products />
      </section>
